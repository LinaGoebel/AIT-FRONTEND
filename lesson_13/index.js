...
list.before(newListItem); //перед
list.after(newListItem); // в конец
list.prepend(newListItem);//стал первым элементом в списке
list.append(newListItem);// стал последним элементом в списке
